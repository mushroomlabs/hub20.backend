# Generated by Django 4.0 on 2022-06-08 21:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "address",
                    hub20.apps.ethereum.models.fields.EthereumAddressField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "hash",
                    hub20.apps.ethereum.models.fields.HexField(
                ...
                ("parent_hash", hub20.apps.ethereum.models.fields.HexField(max_length=64)),
                (
                    "uncle_hashes",
                    django.contrib.postgres.fields.ArrayField(
                        base_field=hub20.apps.ethereum.models.fields.HexField(max_length=64),
                        size=None,
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("hash", hub20.apps.ethereum.models.fields.HexField(db_index=True, max_length=64)),
                (
                    "from_address",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("url", hub20.apps.ethereum.models.fields.Web3ProviderURLField()),
                ...
                ("block_creation_interval", models.PositiveIntegerField(default=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "private_key",
                    hub20.apps.ethereum.models.fields.HexField(max_length=64, unique=True),
                ),
            ],
            bases=("ethereum.basewallet",),
        ),
        ...
        migrations.CreateModel(
            name="AccountTransactionIndexer",
            fields=[
                (
                    "id",
                    models.AutoField(
                ...
                ("max_block_scan_range", models.PositiveIntegerField(default=1000)),
                ("min_block_scan_range", models.PositiveIntegerField(default=1000)),
                (
                    "account",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="%(app_label)s_%(class)s_chain_indexers",
                        to="ethereum.chain",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            name="AccountErc20TokenTransferIndexer",
            fields=[
                (
                    "id",
                    models.AutoField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("sender", hub20.apps.ethereum.models.fields.EthereumAddressField()),
                ("recipient", hub20.apps.ethereum.models.fields.EthereumAddressField()),
