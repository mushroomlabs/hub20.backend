# Generated by Django 4.0 on 2022-05-29 18:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('block', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transactions', to='ethereum.block')),
            ],
        ),
        migrations.CreateModel(
            name='ColdWallet',
            fields=[
                ('basewallet_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='ethereum.basewallet')),
            ],
        ...
        migrations.CreateModel(
            name='Web3Provider',
            fields=[
                ('paymentnetworkprovider_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='core.paymentnetworkprovider')),
                ...
                ('chain', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='providers', to='ethereum.chain')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='fee', to='ethereum.transaction')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chain', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transaction_data', to='ethereum.chain')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chain', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='native_token', to='ethereum.chain')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chain', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='explorers', to='ethereum.chain')),
            ],
        ),
        migrations.CreateModel(
            name='EventIndexer',
            fields=[
                ...
                ('chain', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='indexers', to='ethereum.chain')),
            ],
        ),
        migrations.CreateModel(
            name='Erc20Token',
            fields=[
                ...
                ('chain', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tokens', to='ethereum.chain')),
            ],
            bases=('core.basetoken',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chain', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='info', to='ethereum.chain')),
                ('rollup_for', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='rollups', to='ethereum.chain')),
                ('sidechain_for', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sidechains', to='ethereum.chain')),
                ('testing_for', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='testnets', to='ethereum.chain')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_data', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='ethereum.transactiondatarecord')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='ethereum.transaction')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='blockchain_routes', to='ethereum.basewallet')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chain', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='ethereum.chain')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='block',
            name='chain',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='blocks', to='ethereum.chain'),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', hub20.apps.core.fields.TokenAmountField(decimal_places=18, max_digits=32)),
                ('block', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ethereum.block')),
                ('currency', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.basetoken')),
                ('wallet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='balance_records', to='ethereum.basewallet')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.basetoken')),
                ('transaction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transfers', to='ethereum.transaction')),
            ],
            options={
