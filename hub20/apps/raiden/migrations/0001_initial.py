# Generated by Django 4.0 on 2022-05-31 12:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('partner_address', hub20.apps.ethereum.models.fields.EthereumAddressField(db_index=True)),
                ('balance', hub20.apps.core.fields.TokenAmountField(decimal_places=18, max_digits=32)),
                ('total_deposit', hub20.apps.core.fields.TokenAmountField(decimal_places=18, max_digits=32)),
                ('total_withdraw', hub20.apps.core.fields.TokenAmountField(decimal_places=18, max_digits=32)),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chain', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='raiden_node', to='ethereum.chain')),
            ],
        ),
        migrations.CreateModel(
            name='RaidenTransfer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('address', hub20.apps.ethereum.models.fields.EthereumAddressField()),
                ('token', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='ethereum.erc20token')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_window', models.DurationField(default=hub20.apps.raiden.models.payments.calculate_raiden_payment_window)),
        ...
        migrations.AddField(
            model_name='channel',
            name='raiden',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='channels', to='raiden.raiden'),
        ),
        migrations.AddField(
            model_name='channel',
            name='token_network',
