...
from hub20.apps.raiden.tasks import make_channel_deposit

logger = logging.getLogger(__name__)


class Command(BaseCommand):
    help = "Calls Raiden node to execute channel deposit"
    ...
    def handle(self, *args, **options):
        ...
        return make_channel_deposit(channel_id=channel.id, deposit_amount=options["amount"])
