...
import hub20.apps.core.models.base
import hub20.apps.core.models.checkout
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            bases=(models.Model, hub20.apps.core.models.base.PolymorphicModelMixin),
        ),
        migrations.CreateModel(
            name='Book',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('network', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='routes', to='core.paymentnetwork')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('network', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='providers', to='core.paymentnetwork')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('network', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='account', to='core.paymentnetwork')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='books', to='auth.user')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='PaymentNetworkBook',
            fields=[
                ('book_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='core.book')),
                ('network', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='books', to='core.paymentnetwork')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('expires_on', models.DateTimeField(default=hub20.apps.core.models.checkout.calculate_checkout_expiration_time)),
