    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "logoURI",
                    hub20.apps.core.fields.TokenlistStandardURLField(
            ...
            fields=[
                ...
                (
                    ...
                    models.BigIntegerField(
                        default=hub20.apps.core.models.payments.generate_payment_route_id,
                        unique=True,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "url",
                    models.URLField(
                        help_text="URL for your store public site or information page"
                    ),
                ),
                (
                    "checkout_webhook_url",
                    models.URLField(help_text="URL to receive checkout updates", null=True),
                ),
            ],
            options={
                "abstract": False,
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="%(app_label)s_%(class)s_tokenlists", to="core.BaseToken"
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "canceled_by",
                    models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to="auth.user"),
                ),
                (
                    "transfer",
                    models.OneToOneField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "wrapper",
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE, to="core.basetoken"
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        default=hub20.apps.core.models.checkout.calculate_checkout_expiration_time
                    ),
                ),
                (
                    "store",
