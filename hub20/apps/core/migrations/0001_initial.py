...
try:
    from payments import calculate_blockchain_payment_window as blockchain_payment_window
except ImportError:
    blockchain_payment_window = lambda: (1, 2)

try:
    from payments import calculate_raiden_payment_window as raiden_payment_window
except ImportError:
    raiden_payment_window = lambda: (
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        to="blockchain.baseethereumaccount",
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    django.contrib.postgres.fields.ranges.IntegerRangeField(
                        default=blockchain_payment_window
                    ),
                ),
                (
                    "account",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "payment_window",
                    models.DurationField(default=raiden_payment_window),
                ),
                (
                    "identifier",
