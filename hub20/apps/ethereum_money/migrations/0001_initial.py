    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logoURI', hub20.apps.ethereum_money.fields.TokenlistStandardURLField(blank=True, max_length=512, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('keywords', taggit.managers.TaggableManager(help_text='A comma-separated list of tags.', through='ethereum_money.UUIDTaggedItem', to='taggit.Tag', verbose_name='Tags')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='stable_pair', to='ethereum_money.ethereumtoken')),
            ],
        ),
        migrations.CreateModel(
            name='WrappedToken',
